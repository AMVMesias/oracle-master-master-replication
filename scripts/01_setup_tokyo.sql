-- Configuración inicial TOKYO
CONNECT sys/Oracle123@localhost:1521/TOKYO as sysdba;
...
ALTER SYSTEM SET log_archive_dest_1='LOCATION=/opt/oracle/oradata/TOKYO/archive/ VALID_FOR=(ALL_LOGFILES,ALL_ROLES) DB_UNIQUE_NAME=TOKYO' SCOPE=BOTH;
...
DATAFILE '/opt/oracle/oradata/TOKYO/replicate_data01.dbf' SIZE 500M
