...
CREATE TABLE employees (
    ...
    node_origin VARCHAR2(20) DEFAULT 'LONDRES'
);
...
CREATE SEQUENCE emp_seq START WITH 1001 INCREMENT BY 3;
CREATE SEQUENCE audit_seq START WITH 2 INCREMENT BY 3;
